            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        <h2>Font Awesome 4.3.0</h2>
                        Best collection of font icon. Gives scalable vector icons that can instantly be customized â size, color, drop shadow, and anything that can be done with the CSS styles.
                    </div>
                </div>
                <div class="col-lg-9">
                <div class="ibox float-e-margins">
